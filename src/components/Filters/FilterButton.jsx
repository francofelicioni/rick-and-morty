    ...
    return (
        <div className='p-2'>
            <div className="flex items-center">
                ...
                <label
                    htmlFor={itemId}
                    className={`cursor-pointer hover:font-bold text-black dark:text-white bg-yellow dark:bg-black ${isSelected ? 'underline font-bold' : ''} rounded-lg text-sm px-2.5 py-2`}
                >
                    {item}
                </label>
