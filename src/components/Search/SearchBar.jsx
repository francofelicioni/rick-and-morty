...
const SearchBar = ({searchInput, setSearchInput}) => {
    ...
    return (
        <form className='flex justify-between gap-2 w-full px-6 mx-auto'>
            ...
            <button onClick={e => e.preventDefault()} className='bg-yellow text-brown uppercase cursor-pointer font-bold rounded-lg border border-1 w-36 shadow-lg'>Search</button>
        </form>
    )
}
