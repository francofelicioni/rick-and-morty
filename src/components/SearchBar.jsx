...
const SearchBar = ({searchInput, setSearchInput}) => {
    ...
    return (
        <form className='flex justify-between gap-2 w-full px-5 mx-auto'>
            ...
            <button onClick={e => e.preventDefault()} className='bg-yellow text-unknown uppercase cursor-pointer font-bold rounded-lg border border-1 dark:border-black w-36 shadow-lg'>Search</button>
        </form>
    )
}
